...
land_cover <- read.table("./Data/Geographic Data/46162DO011_2020.csv", sep=",", skip=4, header=TRUE)
...
fwi_states_99 <- data.frame(state = states, fwi_99 = fwi_99)
...
fwi_state <- fwi %>% 
  ...
  mutate(fwi_99_flag = fwi_max >= fwi_99)
